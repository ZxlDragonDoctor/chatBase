...
.kb-card { padding: 20px; cursor: pointer; transition: all 0.2s; }
.kb-card:hover { box-shadow: var(--anime-shadow-pink); }
...
.detail-table tr { border-bottom: 1px solid var(--anime-border-light); }
...
.doc-table th { text-align: left; padding: 8px; font-size: 12px; color: var(--anime-text-muted); border-bottom: 1px solid var(--anime-border-light); }
.doc-table td { padding: 10px 8px; font-size: 13px; border-bottom: 1px solid var(--anime-border-light); }
...
.doc-pagination { display: flex; align-items: center; justify-content: center; gap: 12px; margin-top: 16px; padding-top: 12px; border-top: 1px solid var(--anime-border-light); }
</style>
