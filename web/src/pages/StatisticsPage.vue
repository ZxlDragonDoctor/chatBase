      ...
      <div class="anime-card-body">
        ...
        <div style="margin-bottom: 24px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div v-for="g in groupActive?.topGroups || []" :key="g.groupId" style="display: flex; align-items: center; gap: 14px; padding: 14px 20px; background: var(--anime-bg-card); border: 2px solid var(--anime-border); border-radius: var(--anime-radius-lg); transition: all 0.3s ease;">
...
.anime-word-cloud {
  padding: 24px;
  background: linear-gradient(135deg, rgba(255, 183, 197, 0.08) 0%, rgba(116, 185, 255, 0.08) 100%);
