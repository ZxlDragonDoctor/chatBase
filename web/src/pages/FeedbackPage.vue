...
.input-error {
  box-shadow: 0 0 0 2px rgba(255, 183, 197, 0.3) !important;
}
...
.feedback-history-item.has_reply {
  ...
  background: rgba(184, 233, 148, 0.03);
}
...
.admin-reply-section {
  margin-top: 16px;
  padding-top: 16px;
  border-top: 1px dashed var(--anime-border-light);
}
...
.reply-content {
  padding: 12px;
  background: rgba(184, 233, 148, 0.08);
  border-radius: var(--anime-radius);
  font-size: 14px;
  color: var(--anime-text-primary);
  line-height: 1.6;
