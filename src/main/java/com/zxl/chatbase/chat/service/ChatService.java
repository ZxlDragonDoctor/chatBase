...
public interface ChatService {
     ...
     * @return Dify 回复
     */
    DifyChatResponse chat(Long appId, String channel, String userId, String groupId, String query);

    /**
     * 发送聊天消息（指定应用ID，支持携带文件）
     *
     * @param appId   应用ID
     * @param channel 渠道标识：im / web
     * @param userId  终端用户唯一标识
     ...
     * @return Dify 回复
     */
    DifyChatResponse chat(Long appId, String channel, String userId, String groupId, String query, List<FileInfo> files);
     ...
     * @return Dify 回复
     */
    DifyChatResponse chatWithSession(String sessionId, Long appId, String channel, String userId, String query, List<FileInfo> files);
}
